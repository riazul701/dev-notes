...
deb_office_softwares=( 
	   ...
	   ["rclone"]="https://github.com/rclone/rclone/releases/download/v1.61.0/rclone-v1.61.0-linux-amd64.deb"
...
appimage_office_softwares=("https://github.com/dail8859/NotepadNext/releases/download/v0.5.6/NotepadNext-x86_64.AppImage")
...
tar_office_softwares=("https://releases.hashicorp.com/vagrant/2.3.4/vagrant_2.3.4_linux_amd64.zip"
...
tar_home_softwares=("https://freefilesync.org/get_file.static.php?hash=0442c1f8c27e35e2665d9a227313cc6c")
