...
"flameshot"
"vifm"
"ueberzug" # for-pkg: vifm
"ffmpegthumbnailer" # for-pkg: vifm
"imagemagick" # "convert" for-pkg: vifm
"poppler-utils" # "pdftoppm" is for-pkg: vifm
"djvulibre-bin" # "ddjvu" is for-pkg: vifm
"trash-cli")
